    ...
    return Stack(
      children: [
                              ...
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    //my route bookings
                                    userDetails['role'] != 'owner' && userDetails['enable_my_route_booking_feature'] == "1"
                                        ? InkWell(
                                            onTap: () async{
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  child: Container(
                                                    padding: EdgeInsets.only(left: media.width*0.005,right: media.width*0.005),
                                                    height: media.width*0.05,
                                                    width: media.width*0.1,
                                                    decoration: BoxDecoration(
                                                      borderRadius: BorderRadius.circular(media.width*0.025),
                                                      color: (userDetails['enable_my_route_booking'] == 1) ? Colors.green.withOpacity(0.4) : Colors.grey.withOpacity(0.6),
                                                    ),
                                                    child: Row(
                                                      mainAxisAlignment: (userDetails['enable_my_route_booking'] == 1) ? MainAxisAlignment.end : MainAxisAlignment.start,
                                                      children: [
                                                        Container(
                                    ...
                                    //wallet
                                    userDetails['owner_id'] == null && userDetails['show_bank_info_feature_on_mobile_app'] == "1"
                                        ? InkWell(
                                            onTap: () {
                                              Navigator.push(
                                                  context,
        ...
        //fleet details
                                    ...
                                    //bank details
                                    userDetails['owner_id'] == null && userDetails["show_wallet_feature_on_mobile_app"] == "1"
                                        ? InkWell(
                                            onTap: () {
                                              Navigator.push(
                                                  context,
