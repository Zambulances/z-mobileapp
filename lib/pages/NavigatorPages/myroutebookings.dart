                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(languages[choosenLanguage]['text_home_address'],
                                        style: GoogleFonts.roboto(
                                          fontSize: media.width*sixteen,
                                          fontWeight: FontWeight.w600
                                        ),
                                        ),
                                        if(userDetails['enable_my_route_booking'] != 1)
                                        InkWell(
                                          onTap: ()async{
                                            var nav = await Navigator.push(context, MaterialPageRoute(builder: (context)=>const ChooseHomeAddress()));
                               if(nav != null){
                                 if(nav){
                                   setState(() {
                                          ...
                                          child: Icon(Icons.edit,size: media.width*sixteen,))
                                      ],
                                    ),
                                    SizedBox(height: media.width*0.025,),
                                    SizedBox(width: media.width*0.8,
                                    child: Text(userDetails['my_route_address'],
                                    style: GoogleFonts.roboto(
                               ...
                               if(nav != null){
                                 if(nav){
                                   ...
                                   child: Column(
                                    ...
                                    children: [
                                      Text(languages[choosenLanguage]['text_add_home_address'],
                                      style: GoogleFonts.roboto(
                                        fontSize: media.width*sixteen,
                                        fontWeight: FontWeight.w600
                                      ),
...
if(userDetails['my_route_address'] != null)
                        Button(onTap: ()async{
                          setState(() {
                                                       ...
                                                       var dist = calculateDistance(center.latitude, center.longitude, double.parse(userDetails['my_route_lat'].toString()), double.parse(userDetails['my_route_lng'].toString()));
                                                   
                                                    if(dist > 5000.0 || userDetails['enable_my_route_booking'] == "1"){
                                                  var val = await enableMyRouteBookings(center.latitude, center.longitude);
                                                  if(val == 'logout'){
                                                    navigateLogout();
                                                  }
                                                  else if(val != 'success'){
                                                     setState(() {
                                                      ...
                                                      _error = languages[choosenLanguage]['text_myroute_warning'];
                                                    }
                                                       setState(() {
                                                         _isLoading = false;
                                                       });
                        }, text: (userDetails['enable_my_route_booking'] == 1) ? languages[choosenLanguage]['text_disable_myroute'] : languages[choosenLanguage]['text_enable_myroute'])
              ],
            ),
          ),
                                    ...
                                    children: [
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: (homeAddressConfirmation ==
                                                          '')
                                                      ? Text(
                                                          languages[choosenLanguage]['text_choose_homeaddress'],
                                                          style: GoogleFonts.roboto(
                                      ...
                                      Button(
                                          ...
                                          onTap: ()async{
                                            ...
                                            var add = await addHomeAddress(homeAddressLatLng.latitude, homeAddressLatLng.longitude, homeAddressConfirmation);
                                            if(add == 'success'){
                                              _success = languages[choosenLanguage]['text_address_added_success'];
                                            }else if(add == 'logout'){
                                              navigateLogout();
                                            } else{
                                              _error = add;
