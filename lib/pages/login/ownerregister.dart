...
//                                           child: Text((ownerServiceLocation == '') ? 'choose area' : serviceLocations.firstWhere((element) => element['id'] == ownerServiceLocation)['name'],
//                                           style: GoogleFonts.roboto(
//                                             fontSize: media.width*sixteen,
//                                             color: textColor
//                                           ),
...
//                                       ],
//                                     ),
//                                      Icon((_chooseLocation == false) ? Icons.keyboard_arrow_down : Icons.keyboard_arrow_up)
//                                   ],
//                                 ),
...
//                               child:(serviceLocations.isNotEmpty) ? Column(
//                                 children: serviceLocations.asMap().map((i, value){
...
//                                       child: Text(serviceLocations[i]['name'],
//                                       style: GoogleFonts.roboto(
...
//                                   )
//                                 : Container(),
//                         (nameText.text.isNotEmpty && ownerServiceLocation != '' && emailText.text.isNotEmpty && companyText.text.isNotEmpty && addressText.text.isNotEmpty && cityText.text.isNotEmpty && postalText.text.isNotEmpty && taxText.text.isNotEmpty)
//                                 ? Container(
//                                     width: media.width * 1,
//                                     alignment: Alignment.center,
//                                     child: Button(
...
//                                              if(val == 'true'){
//                                                Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>Referral()), (route) => false);
